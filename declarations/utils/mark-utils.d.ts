 ...
 */
export declare function qualifyScale(context: MarkComponent, scale: Scale, encoding: Encoding, field: string, data?: any[]): void;
/**
 ...
 */
export declare function scaleFrom(arg: Accessor, scale?: Scale): ScaleIdentity | Scale | undefined;
export {};
