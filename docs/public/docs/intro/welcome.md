...
Right now, the best way to get started is to read through the [Dev Logs](/dev-logs/one.md) to get a feel for the features and the design decisions behind them. After that, refer to the [API Reference](/tsdocs/) to get details on component arguments and helper classes.
